...
class TestSignupFunctional:
    ...
    def test_valid_signup(self):
        ...
        try:
            ...
            assert self.signup_page.is_signup_successful(), "Signup should show success indicators"
    ...
    def test_empty_first_name_validation(self):
        ...
        try:
            ...
            user_data = self.data_generator.generate_invalid_user_data('empty_first_name')
            ...
            assert self.signup_page.has_validation_errors(), "Should show validation errors for empty first name"
            
            errors = self.signup_page.get_validation_errors()
            assert any('first name' in error.lower() for error in errors), "Should show first name error"
    ...
    def test_empty_last_name_validation(self):
        ...
        try:
            ...
            user_data = self.data_generator.generate_invalid_user_data('empty_last_name')
            ...
            # Check for validation error
            assert self.signup_page.has_validation_errors(), "Should show validation errors for empty last name"
            
            errors = self.signup_page.get_validation_errors()
            assert any('last name' in error.lower() for error in errors), "Should show last name error"
    ...
    def test_invalid_email_validation(self):
        ...
        try:
            ...
            # Check for validation error
            assert self.signup_page.has_validation_errors(), "Should show validation errors for invalid email"
            
            errors = self.signup_page.get_validation_errors()
            assert any('email' in error.lower() for error in errors), "Should show email error"
    ...
    def test_weak_password_validation(self):
        ...
        try:
            ...
            # Check for validation error
            assert self.signup_page.has_validation_errors(), "Should show validation errors for weak password"
            
            errors = self.signup_page.get_validation_errors()
            assert any('password' in error.lower() for error in errors), "Should show password error"
    ...
    def test_mismatched_passwords_validation(self):
        ...
        try:
            ...
            user_data = self.data_generator.generate_invalid_user_data('mismatched_passwords')
            ...
            # Check for validation error
            assert self.signup_page.has_validation_errors(), "Should show validation errors for mismatched passwords"
            
            errors = self.signup_page.get_validation_errors()
            assert any('password' in error.lower() or 'match' in error.lower() for error in errors), "Should show password mismatch error"
    ...
    def test_terms_and_conditions_required(self):
        ...
        try:
            ...
            # Check for validation error
            assert self.signup_page.has_validation_errors(), "Should show validation errors for not accepting terms"
            
            errors = self.signup_page.get_validation_errors()
            assert any('terms' in error.lower() for error in errors), "Should show terms error"
    ...
    def test_privacy_policy_required(self):
        ...
        try:
            ...
            # Check for validation error
            assert self.signup_page.has_validation_errors(), "Should show validation errors for not accepting privacy policy"
            
            errors = self.signup_page.get_validation_errors()
            assert any('privacy' in error.lower() for error in errors), "Should show privacy error"
    ...
    def test_password_strength_indicator(self):
        ...
        try:
            ...
            if weak_strength and strong_strength:
                assert weak_strength != strong_strength, "Password strength should change with different passwords"
    ...
    def test_form_clear_functionality(self):
        ...
        try:
            ...
            assert self.signup_page.get_field_value('first_name') == '', "First name should be empty"
            assert self.signup_page.get_field_value('last_name') == '', "Last name should be empty"
            assert self.signup_page.get_field_value('email') == '', "Email should be empty"
            assert self.signup_page.get_field_value('password') == '', "Password should be empty"
            assert self.signup_page.get_field_value('confirm_password') == '', "Confirm password should be empty"
            
            # Verify checkboxes are unchecked
            assert not self.signup_page.is_checkbox_checked(self.signup_page.TERMS_CHECKBOX), "Terms checkbox should be unchecked"
            assert not self.signup_page.is_checkbox_checked(self.signup_page.PRIVACY_CHECKBOX), "Privacy checkbox should be unchecked"
