...
class ScreenshotManager:
    ...
    def capture_element_screenshot(self, driver, element, test_name: str, status: str = 'info'):
        ...
        for attempt in range(self.max_attempts):
            try:
                ...
                if attempt == self.max_attempts - 1:
                    self.logger.error(f"Function failed after {self.max_attempts} attempts: {e}")
                    raise
